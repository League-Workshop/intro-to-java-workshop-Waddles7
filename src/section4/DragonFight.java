	...
	public static void main(String[] args) {
		...
		while (playerHealth > 0 && dragonHealth > 0) { // this line of code keeps the battle going until someone's
			...
			// -- Tell the user that the dragon is dead and they took a ton of gold!
				JOptionPane.showMessageDialog(null, "You have slayed the dragon and taken his treasure!");
			}
			// 15. Else
			else {
				JOptionPane.showMessageDialog(null, "You have " + playerHealth + " health points. The dragon has " + dragonHealth + " health points. This is a heated fight!");
			}
